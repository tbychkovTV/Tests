...
*Script alert* configured on *order fill events* are thus useful in that they allow the triggering of alerts at the precise moment an order's execution, 
...
This is done by means of the `strategy.opentrades <https://www.tradingview.com/pine-script-reference/v4/#var_strategy{dot}opentrades>`__ 
parameter in functions which can generate orders. These functions are: 
