...
- The <alias> is the namespace you choose to refer to the library's functions. If you choose to use the ``allTime`` alias as we do in the example below, then you will use ``allTime.<function_mame>()`` in your code to refer to the library's functions.
